...
// {
//     "id": "wlan_optimo",
//     "desc": "[WIFI] considerar alcances optimos\n5Ghz -> 3m / 2.4Ghz -> 4m"
// },
// {
...
export const procesos = [
    {
        ...
        "listado": [
            {
                "id": "ip_check_solt",
                "label": "Figura ip en smart OLT",
                "opt": [
                    {
                        "cond": "si",
                        "list": [
                            "Solicitar el envio de VAS al ONT",
                            "Se configura WAN con el cliente",
                            "Cliente no puede ingresar a la ip del router",
                            "Se reinicia de fabrica",
                            "Se configura el router con el cliente"
                        ]
                    }, {
                        "cond": "no",
                        "list": [
                            "Se agrega al smart wifi manualmente"
                        ]
                    }
                ]
            }, {
                "id": "problema",
                "label": "Tiene problemas mediante->",
                "opt": [
                    {
                        "cond": "lan",
                        "list": [
                            "Se valida que el cable es de win o cat 5e +",
                            "Se valida estado del cable ethernet",
                            "Se prueba en diferentes puertos de la ONT",
                            "se prueba con otros dispositivos",
                            "se crea nueva wan",
                            "se desactiva y se vuelve a activar la conexion LAN",
                            "se valida ip primaria en ONT",
                            "se configura dns en ONT"
                        ]
                    }, {
                        "cond": "wifi",
                        "list": [
                            "Se verifica la banda que esta conectada",
                            "considerar alcances optimos\n5Ghz -> 3m / 2.4Ghz -> 4m",
                            "se prueba con otros dispositivos",
                            "se crea nueva wan",
                            "se desactiva y se vuelve a activar la conexion WLAN",
                            "se configura la zona horaria",
                            "se configura las opciones avanzadas 2.4Ghz / 5Ghz",
                            "se cambia la SSID y la contraseña de la red wifi",
                        ]
                    }
                ]
            }, {
                ...
                "opt": {
                    "cond": "none",
                    "list": [
                        "se revisa la issue list y event list",
                        "se verifica que no este en black list",
                        "se revisa las topologias"
                    ]
                }
            },
